...
import { XCircle, Mail, Phone, Calendar, Clock } from 'lucide-react';
...
export function UserDetails({
  ...
  const dateCreated = formatDate(user.date_joined || user.created_at);
  const lastLoginDate = formatDate(user.last_login);
