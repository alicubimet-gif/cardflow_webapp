...
export interface StaffAssignmentFormDialogProps {
  open: boolean;
  mode: 'create' | 'edit';
  assignment?: any | null;
...
export function StaffAssignmentFormDialog({
  open,
  mode,
  assignment,
  onOpenChange,
}: StaffAssignmentFormDialogProps) {
  const { user } = useAuth();
  ...
  // Dynamic Sub Groups Query: GET /server/mobile/sub-groups?group={groupId}
      ...
      <div className="bg-white w-full sm:max-w-md rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4" noValidate>
          ...
          <div>
            ...
            >
              {isSubgroupsLoading ? (
                <option value="">Loading {subgroupLabelPlural}...Option</option>
              ) : (
                <>
