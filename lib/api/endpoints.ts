export const API_ENDPOINTS = {
  ...
  RECORDS: {
    ...
    SUBMIT: (id: string | number) => `/api/mobile/records/${id}/submit/`,
    APPROVE: (id: string | number) => `/api/mobile/records/${id}/approve/`,
    REJECT: (id: string | number) => `/api/mobile/records/${id}/reject/`,
    REVERT_APPROVAL: (id: string | number) => `/api/mobile/records/${id}/revert-approval/`,
    CORRECTION: (id: string | number) => `/api/mobile/records/${id}/correction/`,
  },
  PHOTOS: {
